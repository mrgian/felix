org 7C00h ;bios puts the os in ram at 0x7c00, so tell nasm to calculate addresses from this address
...
dw AA55h ;put 0xaa55 signature as two last bytes of program